import { getAppointmentsForDay, getInterviewersByDay, getInterviewersForDay, getInterview } from "helpers/selectors";
...
test("getInterviewersByDay returns an array containing the correct interviewers objects", () => { // recheck
